...
void MyTree::Init()
{
   ...
   fChain->Branch("nele ",&nele ,"nele/I");
   ...
   fChain->Branch("chcomp1",&chcomp1,"chcomp1/D");
   fChain->Branch("chcomp2",&chcomp2,"chcomp2/D");
   fChain->Branch("chcomp1sm",&chcomp1sm,"chcomp1sm/D");
   fChain->Branch("chcomp2sm",&chcomp2sm,"chcomp2sm/D");
   fChain->Branch("elcomp1",&elcomp1,"elcomp1/D");
   fChain->Branch("elcomp2",&elcomp2,"elcomp2/D");
   fChain->Branch("neucomp1",&neucomp1,"neucomp1/D");
   fChain->Branch("neucomp2",&neucomp2,"neucomp2/D");
   fChain->Branch("etotjt1",&etotjt1,"etotjt1/D");
   fChain->Branch("etotjt2",&etotjt2,"etotjt2/D");
   ...
   fChain->Branch("ej1b",&ej1b,"ej1b/D");
   fChain->Branch("ej2b",&ej2b,"ej2b/D");
