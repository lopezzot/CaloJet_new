...
for e in energies:
	...
	cmnd1 = "time ./dohist"+" "+str(string)+" "+str(path+string)+" "+str(440.0)
	cmnd2 = "mv bonsai.jetscan_"+str(e)+" chi_0.44/jetscan_"+str(e)+".root"
	os.system(cmnd1)	
	os.system(cmnd2)
'''
...
for e in types:
	string = "jetscan_"+str(e)
	f = "jetscan_"+str(e)+".root"
	cmnd1 = "time ./dohist"+" "+str(string)+" "+str(path+string)+" "+str(430.0)
	os.system(cmnd1)
