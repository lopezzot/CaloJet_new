...
def jetdisplay():
	...
	inputfiles = ["hzjnbn8k_leakage_029/hzjnbn.root"]
	#for geant4.10.5
	inputfiles = ["resultsgeant4.10.5/jetscan_leakage/hzjnbn/hzjnbn.root"]
	#end of geant4.10.5

	#for geant4.10.5 FTFPBERT
	inputfiles = ["results_FTFPBERT/noBnoX0/2j/hzjnbn.root"]
